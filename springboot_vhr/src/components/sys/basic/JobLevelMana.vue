<template>
  <div>
    <div>
      ...
      <el-select v-model="jl.titleLevel" placeholder="请选择职称等级" size="small" style="margin-left: 5px;margin-right: 5px">
        <el-option
    ...
    <div style="margin-top: 10px">
      ...
      >
        ...
        <el-table-column
            label="操作">
          <template slot-scope="scope">
            <el-button type="small" @click="showEditView(scope.row)">编辑</el-button>
            <el-button type="danger" size="small" @click="deleteHandler(scope.row)">删除</el-button>
          </template>
        </el-table-column>
      </el-table>
      <el-button type="danger" size="small" style="margin-top: 10px" @click="deleteMany"
