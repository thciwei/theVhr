package com.thciwei.proj.utils;
...
public class POIUtils {
    public static ResponseEntity<byte[]> employee2Excel(List<com.thciwei.proj.bean.Employee> list) {
        //1.创建一个excel文档
        ...
        //设置管理员
        docInfo.setManager("thciwei");
        //设置公司信息
        docInfo.setCompany("com.thciwei");
        //4.获取文档摘要信息
        SummaryInformation sumInfo = workbook.getSummaryInformation();
        //文档标题
        sumInfo.setTitle("员工信息表");
        //文档作者
        sumInfo.setAuthor("thciwei");
        //文档备注
        sumInfo.setComments("本文档由 thciwei 提供");
        //5.创建标题行样式
    ...
    public static List<Employee> excel2Employee(MultipartFile file, List<Nation> allNations, List<Politicsstatus> allPoliticsstaus, List<Department> allDepartments, List<Position> allPositions, List<JobLevel> allJobLevels) {
                            ...
                            case STRING:
                                ...
                                switch (k) {
                                    ...
                                    case 8:
                                        ...
                                        break;
                                    case 9:
                                        int politicstatusIndex = allPoliticsstaus.indexOf(new Politicsstatus(cellValue));
                                        employee.setPoliticId(allPoliticsstaus.get(politicstatusIndex).getId());
                                        break;
                                    case 10:
